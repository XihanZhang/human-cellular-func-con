...
--cell maps
      ...
      |--Schaefer_atalas
                |--Jorstad
                      ...
                      |--cell fractions imputed from Jorstad dataset and combining all AHBA donors are aggerated in surface-based Schaefer atalses (100-1000 parces).
                |--Lake
                      |--donor_level_cell_maps: cell fractions imputed from Lake dataset and each individual AHBA donor are aggerated in surface-based Schaefer atalses.
                      |--cell fractions imputed from Lake dataset and combining all AHBA donors are aggerated in surface-based Schaefer atalses (100-1000 parces).
```
