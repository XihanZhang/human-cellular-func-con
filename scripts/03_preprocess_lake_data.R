...
for (region in c('FrontalCortex', 'VisualCortex')){
    ...
    save(seuset, col_df, file = paste0(umi_dir, 'lake2018/GSE97930_',region,'_snDrop-seq_UMI_Count_Matrix_08-01-2017_seurat_new.Rdata'))
...
# AHBA data
load(file=paste0(base_dir, '/data/ahba/ahba_ctx_norm_abagen.Rdata'), verbose=T)
load(file=paste0(base_dir, '/data/ahba/donorData_obj_abagen.Rdata'), verbose=T)
