...
# this script will project fsLR parcellations to individual AHBA freesurfer space
# this script was adapted from Anderson et al 2020 NatCom
# (https://github.com/HolmesLab/2020_NatComm_interneurons_cortical_function_schizophrenia/blob/master/scripts/02_project_freesurfer.bash)

module load FreeSurfer/6.0.0

# Set up directories
# your project base dir
project_dir=/gpfs/milgram/project/holmes/xz555/gradient_shift

# path to the AHBA freesurfer files for each donor
# they are stored wherever the abagen download dir sit, within '/abated-data/freesurfer'
AHBA_fs_dir=${project_dir}/data/ahba_fs

# path to the connectome work Bench software
...
for donor in 9861 10021 12876 14380 15496 15697; do
  ...
  # FS space vol/surf data is slightly offset from scanner space
